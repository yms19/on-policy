...
do
    ...
    --num_agents ${num_agents} --num_landmarks ${num_landmarks} --seed 3 --use_selfplay \
    ...
    --episode_length 12 --world_length 240 --inference_interval 15 --save_interval 100 \
    --num_env_steps 45000000 --ppo_epoch 10 --use_ReLU --activation_id 0 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --entropy_coef 0.05 \
