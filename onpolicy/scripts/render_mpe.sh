...
do
    ...
    --d_range ${d_range}  --adversary_speed 0.0003 --p_noise 0 --detect_noise 0.15 \
    ...
    --model_dir "./results/MPE/simple_tag/rmappo/way_points(escape_nearest)/wandb/run-20230525_055348-gc8ws554/files"
done
