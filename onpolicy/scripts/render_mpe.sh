...
do
    ...
    --num_agents ${num_agents} --num_landmarks ${num_landmarks} --seed 10 \
    --n_training_threads 1 --n_rollout_threads 1 --use_render \
    --episode_length 120 --script_length 120 --render_episodes 100 --use_wandb \
    --model_dir "./results/MPE/with_detect/mask" 
done
