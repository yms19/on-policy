...
do
    ...
    --episode_length 12 --world_length 240 --inference_interval 15 --render_episodes 1 --use_wandb \
    --model_dir "./results/MPE/simple_tag/rmappo/way_points/wandb/run-20230427_025910-153cc75g/files"
done
